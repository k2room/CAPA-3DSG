...
def get_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--dataset", type=str, required=True, choices=["FunGraph3D", "SceneFun3Ddev", "SceneFun3Dtest", "PADO"])

...
if __name__ == '__main__':
    ...
    if args.dataset == 'SceneFun3D':
        ...
        # scene_pc = o3d.io.read_point_cloud(str(Path(args.root_path) / args.split / str(args.scene).split('/')[0] / (str(args.scene).split('/')[0]+'_laser_scan.ply')))
        # refined_transform = np.load(str(Path(args.root_path) / args.split / args.scene  / (str(args.scene).split('/')[1]+'_refined_transform.npy')))
        ...
        # print("Loaded scene_pc, refined_transform", str(Path(args.root_path) / args.split / str(args.scene).split('/')[0] / (str(args.scene).split('/')[0]+'_laser_scan.ply')), str(Path(args.root_path) / args.split / args.scene  / (str(args.scene).split('/')[1]+'_refined_transform.npy')))
    ...
    print("Loaded object, parts, all labels embeddings")

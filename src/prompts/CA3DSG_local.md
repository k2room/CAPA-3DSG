...
- A curtain rod is used for guiding and supporting curtain.
- A lever or a pedal of a trashcan is used for opening it.
- A button of an oven is used for pressing to start and operate.
- A lever of a faucet is used for rotating or adjusting to control the water.
- A handle or a knob of a door is used for rotating or pulling to open or close it.
- A button at the top of a toilet is used for pressing to flush.
- A vacuum cleaner handle is used for lifting up the vacuum cleaner.